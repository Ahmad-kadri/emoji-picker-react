 ...
 */
function DynamicPickerStyle(_ref) {
  var css = _ref.css;
  var _usePickerConfig = usePickerConfig(),
    nonce = _usePickerConfig.nonce;
  return React.createElement("style", {
    nonce: nonce,
    suppressHydrationWarning: true,
    dangerouslySetInnerHTML: {
...
function PickerRootElement(_ref2) {
  ...
  var pickerCss = buildPickerCss("#" + pickerId, !reactionsMode ? width : undefined, !reactionsMode ? height : undefined, styleProps);
  return React.createElement(React.Fragment, null, React.createElement(DynamicPickerStyle, {
    css: pickerCss
...
function cssPropertiesToString(style) {
  return Object.entries(style).filter(function (_ref4) {
    var v = _ref4[1];
    return v !== undefined && v !== null && v !== '';
  }).map(function (_ref5) {
    var prop = _ref5[0],
      value = _ref5[1];
    var cssProp = prop.replace(/([A-Z])/g, function (m) {
      return "-" + m.toLowerCase();
    });
    return cssProp + ":" + value;
  }).join(';');
}
function buildPickerCss(selector, width, height, extraStyle) {
  var declarations = [];
  if (width !== undefined) declarations.push("width:" + width);
  if (height !== undefined) declarations.push("height:" + height);
  var extra = cssPropertiesToString(extraStyle);
...
function EmojiImg(_ref) {
  var emojiName = _ref.emojiName,
    sizeClassName = _ref.sizeClassName,
  ...
  return React.createElement("img", {
    src: imgUrl,
    alt: emojiName,
    className: flairup.cx(styles$3.emojiImag, emojiStyles.external, emojiStyles.common, sizeClassName, className),
...
function NativeEmoji(_ref) {
  ...
  return React.createElement("span", {
    className: flairup.cx(styles$4.nativeEmoji, emojiStyles.common, emojiStyles.external, sizeClassName, className),
    "data-unified": unified
...
var SIZE_CLASS_CACHE = /*#__PURE__*/new Map();
function getSizeClassName(size) {
  var _stylesheet$create;
  if (SIZE_CLASS_CACHE.has(size)) {
    return SIZE_CLASS_CACHE.get(size);
  }
  var styles = stylesheet.create((_stylesheet$create = {}, _stylesheet$create["emojiSize_" + size] = {
    width: size + "px",
    height: size + "px",
    fontSize: size + "px"
  }, _stylesheet$create));
  var className = flairup.cx(styles["emojiSize_" + size]);
...
function ViewOnlyEmoji(_ref) {
  ...
  var sizeClassName = size ? getSizeClassName(size) : undefined;
...
function useEmojiVirtualization(_ref) {
  ...
  var emojis = emojisToPush.reduce(function (accumulator, emoji, index) {
    ...
    if (!isCategoryVisible) {
      ...
      accumulator.push(React.createElement("span", {
        key: unified,
        className: flairup.cx(emojiSpacerClass),
        "aria-hidden": "true"
      }));
      return accumulator;
    }
...
var emojiSpacerStyles = /*#__PURE__*/stylesheet.create({
  emojiSpacer: {
    display: 'block',
    width: 'var(--epr-emoji-fullsize)',
    height: 'var(--epr-emoji-fullsize)'
...
var emojiSpacerClass = emojiSpacerStyles.emojiSpacer;
...
function MeasureEmoji() {
  ...
  return (
    ...
    React.createElement("div", {
      ref: ref,
      className: flairup.cx(styles$8.measureWrapper)
    }, React.createElement(ClickableEmoji, {
      emoji: dummyEmoji,
      unified: unified,
      emojiStyle: emojiStyle,
...
function EmojiList(_ref) {
  ...
  var topOffset = 0;
  return React.createElement("ul", {
    className: flairup.cx(styles$9.emojiList),
    ref: EmojiListRef
...
function EmojiVariationPicker() {
  ...
  if (!visible && AnchoredEmojiRef.current) {
    ...
    var _getPointerStyle;
    top = getTop();
    pointerLeft = (_getPointerStyle = getPointerStyle()) == null ? void 0 : _getPointerStyle.left;
  }
  var dynamicCss = ["#" + pickerId + "{top:" + ((_top = top) != null ? _top : 0) + "px}", pointerLeft !== undefined ? "#" + pickerId + " .epr-emoji-pointer{left:" + pointerLeft + "px}" : ''].filter(Boolean).join('');
  return React.createElement(React.Fragment, null, React.createElement(DynamicPickerStyle, {
    css: dynamicCss
  }), React.createElement("div", {
    id: pickerId,
    ref: VariationPickerRef,
    className: flairup.cx(styles$a.variationPicker, getMenuDirection() === Direction.Down && styles$a.pointingUp, visible && styles$a.visible)
    ...
    className: flairup.cx(styles$a.pointer)
  })));
}
...
var styles$a = /*#__PURE__*/stylesheet.create(/*#__PURE__*/_extends({
  variationPicker: {
...
function Body() {
  ...
  return React.createElement("div", {
    className: flairup.cx(styles$b.body, commonInteractionStyles.hiddenOnReactions),
    ref: BodyRef
...
function Flex(_ref) {
  ...
  return React.createElement("div", {
    className: flairup.cx(styles$c.flex, className, styles$c[direction])
  }, children);
}
var styles$c = /*#__PURE__*/stylesheet.create((_stylesheet$create = {
  flex: {
    display: 'flex'
  }
...
function Space(_ref) {
  ...
  return React.createElement("div", {
    className: flairup.cx(styles$d.space, className)
  });
}
...
function Absolute(_ref) {
  var children = _ref.children,
    className = _ref.className;
  return React.createElement("div", {
    className: flairup.cx(styles$e.absolute, className)
  }, children);
}
...
function Relative(_ref) {
  var children = _ref.children,
    className = _ref.className;
  return React.createElement("div", {
    className: flairup.cx(styles$f.relative, className)
  }, children);
}
...
function BtnSkinToneVariation(_ref) {
  ...
  return React.createElement(Button, {
    onClick: onClick,
    className: flairup.cx("epr-tone-" + skinToneVariation, styles$g.tone, !isOpen && styles$g.closedTone, isActive && styles$g.active),
...
var EXPANDED_SIZE = ITEM_SIZE * skinToneVariations.length; // 168px
function SkinTonePickerMenu() {
  return React.createElement(Relative, {
    className: flairup.cx(styles$h.menuRelative)
  }, React.createElement(Absolute, {
    className: flairup.cx(styles$h.menuAbsolute)
...
function SkinTonePicker(_ref) {
  ...
  return React.createElement(Relative, {
    className: flairup.cx(styles$h.skinTones, vertical && styles$h.vertical, isOpen && styles$h.open, vertical && isOpen && styles$h.verticalShadow)
  }, React.createElement("div", {
    className: flairup.cx(styles$h.select),
    ref: SkinTonePickerRef
  }, skinToneVariations.map(function (skinToneVariation) {
...
var styles$h = /*#__PURE__*/stylesheet.create({
  skinTones: {
    '.': 'epr-skin-tones',
    '--': {
...
function Preview() {
  ...
  return React.createElement(Flex, {
    className: flairup.cx(styles$i.preview, commonInteractionStyles.hiddenOnReactions, reactionsOpen && styles$i.hideOnReactions)
...
function PreviewBody() {
  ...
  function PreviewContent() {
    ...
    return React.createElement(React.Fragment, null, React.createElement("div", null, show ? React.createElement(ViewOnlyEmoji, {
      ...
      size: 45,
      getEmojiUrl: getEmojiUrl,
      className: flairup.cx(styles$i.emoji)
      ...
      className: flairup.cx(styles$i.label)
    }, show ? emojiName$1(emoji) : defaultText));
  }
}
var styles$i = /*#__PURE__*/stylesheet.create({
  preview: {
    alignItems: 'center',
...
function CategoryButton(_ref) {
  ...
  return React.createElement(Button, {
    ...
    className: flairup.cx(styles$j.catBtn, commonInteractionStyles.categoryBtn, hasCustomIcon ? styles$j.customIcon : "epr-icn-" + category, (_cx = {}, _cx[ClassNames.active] = isActiveCategory, _cx)),
    onClick: onClick,
...
function CategoryNavigation() {
  ...
  return React.createElement("div", {
    className: flairup.cx(styles$k.nav),
    role: "tablist",
...
var styles$k = /*#__PURE__*/stylesheet.create({
  nav: {
    '.': 'epr-category-nav',
    display: 'flex',
    flexDirection: 'row',
...
function BtnClearSearch() {
  ...
  return React.createElement(Button, {
    className: flairup.cx(styles$l.btnClearSearch, commonInteractionStyles.visibleOnSearchOnly),
    onClick: clearSearch,
    "aria-label": searchClearButtonLabel,
    title: searchClearButtonLabel
  }, React.createElement("div", {
    className: flairup.cx(styles$l.icnClearnSearch)
  }));
}
var HoverDark = {
  ':hover': {
...
var styles$l = /*#__PURE__*/stylesheet.create(/*#__PURE__*/_extends({
  btnClearSearch: {
...
function IcnSearch() {
  return React.createElement("div", {
    className: flairup.cx(styles$m.icnSearch)
  });
}
var styles$m = /*#__PURE__*/stylesheet.create(/*#__PURE__*/_extends({
  icnSearch: {
    '.': 'epr-icn-search',
    content: '',
    position: 'absolute',
...
function SearchContainer() {
  ...
  return React.createElement(Flex, {
    className: flairup.cx(styles$n.overlay)
...
function Search() {
  ...
  return React.createElement(Relative, {
    className: flairup.cx(styles$n.searchContainer)
  }, React.createElement("input", {
    // eslint-disable-next-line jsx-a11y/no-autofocus
    autoFocus: autoFocus,
    "aria-label": 'Type to search for an emoji',
    onFocus: closeAllOpenToggles,
    className: flairup.cx(styles$n.search),
    type: "text",
    ...
    role: "status",
    className: flairup.cx('epr-status-search-results', styles$n.visuallyHidden),
    "aria-live": "polite",
    id: "epr-search-id",
    "aria-atomic": "true"
  }, statusSearchResults) : null, React.createElement(IcnSearch, null), React.createElement(BtnClearSearch, null));
}
var styles$n = /*#__PURE__*/stylesheet.create(/*#__PURE__*/_extends({
  overlay: {
    padding: 'var(--epr-header-padding)',
...
function ExportedEmoji(_ref) {
  var unified = _ref.unified,
    ...
    nonce = _ref.nonce;
  var id = React.useId();
  var sizeClass = "epr-exported-" + id.replace(/:/g, '');
  if (!unified && !emojiUrl && !getEmojiUrl) {
    return null;
  }
  return React.createElement(React.Fragment, null, size && React.createElement("style", {
    nonce: nonce,
    suppressHydrationWarning: true,
    dangerouslySetInnerHTML: {
