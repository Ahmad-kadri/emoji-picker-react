  ...
  React.useEffect(function () {
    ...
    function onMouseOver(e) {
      ...
      if (belowFoldByPx < buttonHeight) {
        ...
        (_buttonFromTarget = buttonFromTarget(document.activeElement)) == null ? void 0 : _buttonFromTarget.blur();
    ...
    return function () {
      bodyRef == null ? void 0 : bodyRef.removeEventListener('mouseover', onMouseOver, true);
...
function setPreviewFromButton(button, setPreviewEmoji) {
