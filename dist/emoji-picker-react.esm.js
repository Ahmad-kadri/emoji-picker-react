import React__default, { memo, createElement, useState, useEffect, useContext, createContext, useRef, useMemo, createRef, useCallback, useId, Fragment, useLayoutEffect, Suspense, Component } from 'react';
...
function PickerRootElement(_ref2) {
  ...
  return createElement(Fragment, null, createElement(DynamicPickerStyle, {
    css: pickerCss
  }), createElement("aside", {
    id: pickerId,
...
function EmojiImg(_ref) {
  ...
  return createElement("img", {
    src: imgUrl,
    alt: emojiName,
    className: cx(styles$3.emojiImag, emojiStyles.external, emojiStyles.common, sizeClassName, className),
...
function NativeEmoji(_ref) {
  ...
  return createElement("span", {
    className: cx(styles$4.nativeEmoji, emojiStyles.common, emojiStyles.external, sizeClassName, className),
    "data-unified": unified
...
function getSizeClassName(size) {
  ...
  var className = cx(styles["emojiSize_" + size]);
...
function useEmojiVirtualization(_ref) {
  ...
  var emojis = emojisToPush.reduce(function (accumulator, emoji, index) {
    ...
    if (!isCategoryVisible) {
      ...
      accumulator.push(createElement("span", {
        key: unified,
        className: cx(emojiSpacerClass),
        "aria-hidden": "true"
      }));
      return accumulator;
    }
...
function MeasureEmoji() {
  ...
  return (
    ...
    createElement("div", {
      ref: ref,
      className: cx(styles$8.measureWrapper)
    }, createElement(ClickableEmoji, {
      emoji: dummyEmoji,
      unified: unified,
      emojiStyle: emojiStyle,
...
function EmojiList(_ref) {
  ...
  var topOffset = 0;
  return createElement("ul", {
    className: cx(styles$9.emojiList),
    ref: EmojiListRef
...
function EmojiVariationPicker() {
  ...
  return createElement(Fragment, null, createElement(DynamicPickerStyle, {
    ...
    className: cx(styles$a.variationPicker, getMenuDirection() === Direction.Down && styles$a.pointingUp, visible && styles$a.visible)
...
function Body() {
  ...
  return createElement("div", {
    className: cx(styles$b.body, commonInteractionStyles.hiddenOnReactions),
    ref: BodyRef
...
function Flex(_ref) {
  ...
  return createElement("div", {
    className: cx(styles$c.flex, className, styles$c[direction])
  }, children);
}
...
function Space(_ref) {
  ...
  return createElement("div", {
    className: cx(styles$d.space, className)
  });
}
...
function Absolute(_ref) {
  var children = _ref.children,
    className = _ref.className;
  return createElement("div", {
    className: cx(styles$e.absolute, className)
  }, children);
}
...
function Relative(_ref) {
  var children = _ref.children,
    className = _ref.className;
  return createElement("div", {
    className: cx(styles$f.relative, className)
  }, children);
}
...
function BtnSkinToneVariation(_ref) {
  ...
  return createElement(Button, {
    onClick: onClick,
    className: cx("epr-tone-" + skinToneVariation, styles$g.tone, !isOpen && styles$g.closedTone, isActive && styles$g.active),
...
function SkinTonePickerMenu() {
  return createElement(Relative, {
    className: cx(styles$h.menuRelative)
  }, createElement(Absolute, {
    className: cx(styles$h.menuAbsolute)
...
function SkinTonePicker(_ref) {
  ...
  return createElement(Relative, {
    className: cx(styles$h.skinTones, vertical && styles$h.vertical, isOpen && styles$h.open, vertical && isOpen && styles$h.verticalShadow)
  }, createElement("div", {
    className: cx(styles$h.select),
...
function Preview() {
  ...
  return createElement(Flex, {
    className: cx(styles$i.preview, commonInteractionStyles.hiddenOnReactions, reactionsOpen && styles$i.hideOnReactions)
...
function CategoryButton(_ref) {
  ...
  return createElement(Button, {
    ...
    className: cx(styles$j.catBtn, commonInteractionStyles.categoryBtn, hasCustomIcon ? styles$j.customIcon : "epr-icn-" + category, (_cx = {}, _cx[ClassNames.active] = isActiveCategory, _cx)),
    onClick: onClick,
...
function BtnClearSearch() {
  ...
  return createElement(Button, {
    className: cx(styles$l.btnClearSearch, commonInteractionStyles.visibleOnSearchOnly),
    onClick: clearSearch,
    "aria-label": searchClearButtonLabel,
    title: searchClearButtonLabel
  }, createElement("div", {
    className: cx(styles$l.icnClearnSearch)
  }));
}
var HoverDark = {
  ':hover': {
...
function IcnSearch() {
  return createElement("div", {
    className: cx(styles$m.icnSearch)
  });
}
...
function Search() {
  ...
  return createElement(Relative, {
    className: cx(styles$n.searchContainer)
  }, createElement("input", {
    // eslint-disable-next-line jsx-a11y/no-autofocus
    autoFocus: autoFocus,
    "aria-label": 'Type to search for an emoji',
    onFocus: closeAllOpenToggles,
    className: cx(styles$n.search),
    type: "text",
    ...
    role: "status",
    className: cx('epr-status-search-results', styles$n.visuallyHidden),
    "aria-live": "polite",
    id: "epr-search-id",
    "aria-atomic": "true"
...
function ExportedEmoji(_ref) {
  ...
  return createElement(Fragment, null, size && createElement("style", {
    nonce: nonce,
    suppressHydrationWarning: true,
    dangerouslySetInnerHTML: {
