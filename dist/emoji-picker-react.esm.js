...
function visibleEmojiOneRowUp(element) {
  ...
  // ArrowDown/Up drift.
  var countInRow = elementCountInRow(closestEmojiList(element), element);
...
function closestEmojiList(element) {
  if (!element) {
    return null;
  }
  return element.closest(asSelectors(ClassNames.emojiList));
}
